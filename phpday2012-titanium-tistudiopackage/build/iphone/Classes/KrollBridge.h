...
@interface Phpday2012_DrupaniumObject : KrollCoverageObject {
#else
@interface Phpday2012_DrupaniumObject : KrollObject {
#endif
@private
...
extern NSString * Phpday2012_Drupanium$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Phpday2012_DrupaniumObject *_phpday2012_drupanium;
	BOOL shutdown;
