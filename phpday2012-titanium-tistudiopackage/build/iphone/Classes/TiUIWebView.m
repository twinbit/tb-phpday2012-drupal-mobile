...
static NSString * const kPhpday2012_DrupaniumJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_phpday2012_drupaniumInjection
{
	...
	[html appendString:kPhpday2012_DrupaniumJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Phpday2012_Drupanium bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _phpday2012_drupaniumInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to Phpday2012_Drupanium support.",url);
				}
			}
