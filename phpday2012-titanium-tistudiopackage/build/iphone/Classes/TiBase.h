...
// in simulator we redefine to format for Phpday2012_Drupanium Developer console
...
{\
	NSString * exceptionName = [@"org.phpday2012_drupanium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.phpday2012_drupanium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPhpday2012_DrupaniumNativeItemNone = -1, 
	UIPhpday2012_DrupaniumNativeItemSpinner = -2,
	UIPhpday2012_DrupaniumNativeItemProgressBar = -3,
	
	UIPhpday2012_DrupaniumNativeItemSlider = -4,
	UIPhpday2012_DrupaniumNativeItemSwitch = -5,
	UIPhpday2012_DrupaniumNativeItemMultiButton = -6,
	UIPhpday2012_DrupaniumNativeItemSegmented = -7,
	
	UIPhpday2012_DrupaniumNativeItemTextView = -8,
	UIPhpday2012_DrupaniumNativeItemTextField = -9,
	UIPhpday2012_DrupaniumNativeItemSearchBar = -10,
	
	UIPhpday2012_DrupaniumNativeItemPicker = -11,
	UIPhpday2012_DrupaniumNativeItemDatePicker = -12,
	
	UIPhpday2012_DrupaniumNativeItemInfoLight = -13,
	UIPhpday2012_DrupaniumNativeItemInfoDark = -14,
	
	UIPhpday2012_DrupaniumNativeItemDisclosure = -15,
	
	UIPhpday2012_DrupaniumNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Phpday2012_Drupanium instances of
