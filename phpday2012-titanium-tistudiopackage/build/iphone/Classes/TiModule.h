...
/**
 The base class for all Phpday2012_Drupanium modules
 */
...
/**
 Phpday2012_Drupanium Platform calls this method on startup.
 */
-(void)startup;

/**
 Phpday2012_Drupanium Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Phpday2012_Drupanium Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Phpday2012_Drupanium Platform calls this method on resume.
 @param sender The sender of the event.
 */
