...
//Rare exceptions to indicate a bug in the _phpday2012_drupanium code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Phpday2012_Drupanium proxies.
 */
