 ...
 * Copyright (c) 2009-2011 by Phpday2012_Drupanium, Inc. All Rights Reserved.
...
//@interface Phpday2012_DrupaniumObject : NSObject
//@end

@interface Phpday2012_DrupaniumObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Phpday2012_DrupaniumObject class]])
		{
			for (NSString *key in [[(Phpday2012_DrupaniumObject*)o modules] allKeys])
			{
