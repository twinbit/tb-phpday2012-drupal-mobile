...
search.addEventListener('return', function(e) {
	...
	if (Titanium.Network.online == true || Titanium.Network.online == false) {
		...
		xhr.onload = function requestReceived(e) {
			...
			if (statusCode == 200) {
				...
				info('JSON Response:' + response);
				
				// Parse the response
				var result = JSON.parse(response);
				
				info('JSON Result parsed' + result);
